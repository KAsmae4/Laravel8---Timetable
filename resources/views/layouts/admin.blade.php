...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
  <header class="app-header navbar">
    ...
    <a class="navbar-brand center header-left" href="#">
      <span class="navbar-brand-full"> <img src="{{ asset('assets/ofppt.png') }}" width="50" height="60" alt=""></span>
      <span class="navbar-brand-minimized"> <img src="{{ asset('assets/ofppt.png') }}" width="50" height="60" alt=""></span>
    </a>
