...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user_create')): ?>
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            <a class="btn btn-success" href="<?php echo e(route("admin.users.create")); ?>?student">
                <?php echo e(trans('global.add')); ?> New Student
            </a>
        </div>
    </div>
<?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel-School-Timetable-Calendar\resources\views/admin/users/index.blade.php ENDPATH**/ ?>