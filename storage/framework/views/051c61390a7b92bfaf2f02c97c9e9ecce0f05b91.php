                                    ...
                                    <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(is_array($value)): ?>
                                            <td rowspan="<?php echo e($value['rowspan']); ?>" class="align-middle text-center" style="background-color:#f0f0f0">
                                                ...
                                                <?php echo e($value['salle']); ?><br>
                                                Formateur: <?php echo e($value['teacher_name']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel_timetable\resources\views/admin/calendar.blade.php ENDPATH**/ ?>