...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
  <header class="app-header navbar">
    ...
    <a class="navbar-brand center header-left" href="#">
      <span class="navbar-brand-full"> <img src="<?php echo e(asset('assets/ofppt.png')); ?>" width="50" height="60" alt=""></span>
      <span class="navbar-brand-minimized"> <img src="<?php echo e(asset('assets/ofppt.png')); ?>" width="50" height="60" alt=""></span>
    </a>
    <button class="navbar-toggler sidebar-toggler d-md-down-none" type="button" data-toggle="sidebar-lg-show">
      <span class="navbar-toggler-icon" href="javascript:void(0);" id="toggle_btn"></span>
    </button>
  ...
  <script>
    $(function() {
      let copyButtonTrans = '<?php echo e(trans('
      global.datatables.copy ')); ?>'
      let csvButtonTrans = '<?php echo e(trans('
      global.datatables.csv ')); ?>'
      let excelButtonTrans = '<?php echo e(trans('
      global.datatables.excel ')); ?>'
      let pdfButtonTrans = '<?php echo e(trans('
      global.datatables.pdf ')); ?>'
      let printButtonTrans = '<?php echo e(trans('
      global.datatables.print ')); ?>'
      let colvisButtonTrans = '<?php echo e(trans('
      global.datatables.colvis ')); ?>'
      let selectAllButtonTrans = '<?php echo e(trans('
      global.select_all ')); ?>'
      let selectNoneButtonTrans = '<?php echo e(trans('
      global.deselect_all ')); ?>'
...
</html><?php /**PATH C:\xampp\htdocs\Laravel-School-Timetable-Calendar\resources\views/layouts/admin.blade.php ENDPATH**/ ?>